package com.menoia.livros.server.injector;
...
/**
 * <p>
 * This <code>GuiceTestRunner</code> class is used for running tests that has
...
public class GuiceTestRunner extends BlockJUnit4ClassRunner {
    ...
    protected Injector createInjector() throws Exception {
        ...
        for (int i = 0; i < moduleClasses.length; i++) {
            ...
            try {
                ...
                throw new Exception("The module " + moduleClasses[i]
                    + " is required by the test and cannot be instantiated.", e);
            }
        }
    ...
    protected void validateConstructor(List<Throwable> errors) {
        ...
        for (Constructor<?> c : constructors) {
            ...
            boolean hasInject = (c.getAnnotation(Inject.class) != null) || ((c.getAnnotation(javax.inject.Inject.class) != null));
