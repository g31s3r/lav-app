...
import com.menoia.lav.vaadin.report.SalesReport;
...
public class ReportsModule implements Module, Command {
	...
	public void add(MDIWindow mdiWindow, enterpriseapp.hibernate.dto.User user) {
		...
		callingReportItem = mdiWindow.getMenuBar().addItem(Constants.uiReports, null).addItem(Constants.uiSalesReport, this);
	}
	...
	public void menuSelected(MenuItem selectedItem) {
		if(callingReportItem.equals(selectedItem)) {
			...
			mdiWindow.addWorkbenchContent(report, Constants.uiSalesReport, null, true, false);
		}
	}
